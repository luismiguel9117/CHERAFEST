...
export default function Hero({ onOpenCalendar, onOpenWishlist, onOpenGallery }) {
  return (
    <header 
      id="top" 
      className="relative w-full h-screen min-h-[660px] max-h-[1080px] overflow-hidden select-none bg-[#fff2f6]"
    >
      ...
      <img
        ...
        className="absolute left-1/2 -translate-x-1/2 top-[10%] sm:top-[11%] h-[44vh] max-h-[440px] min-h-[220px] w-auto object-contain z-25 drop-shadow-sm"
      />

      {/* 8. BLOQUE CENTRAL DE TEXTOS, FECHA Y BOTÓN MÁS GRANDE Y PROMINENTE SIN SUPERPOSICIÓN */}
      <div className="absolute left-1/2 -translate-x-1/2 top-[55%] sm:top-[55%] md:top-[54%] w-[94%] max-w-[720px] text-center flex flex-col items-center gap-3 sm:gap-4 z-30 pointer-events-auto">
        ...
        <button
          ...
          className="bg-[#ef7fae] hover:bg-[#e0669a] text-white font-baloo font-black text-sm sm:text-base md:text-lg px-10 py-3 sm:px-12 sm:py-3.5 rounded-full shadow-[0_6px_0_rgba(214,105,155,0.4)] flex items-center gap-2.5 transition-all hover:scale-105 active:scale-95 cursor-pointer uppercase tracking-wider"
        >
