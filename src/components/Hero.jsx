...
export default function Hero({ onOpenCalendar, onOpenWishlist, onOpenGallery }) {
  return (
    ...
    >
      ...
      {/* 2. Borde Inferior de Encaje (borde.png con rotación 180) - Ajustado en móvil para visibilidad total */}
      <img
        src="/assets/borde.png"
        alt="Borde Encaje Inferior"
        className="absolute bottom-[3.5%] sm:bottom-0 left-0 right-0 w-full h-12 sm:h-24 md:h-28 object-fill z-20 pointer-events-none rotate-180"
      />

      {/* 3. Título Gráfico Central (titulo.png) - Subido sutilmente en móvil */}
      <img
        src="/assets/titulo.png"
        alt="Título Charo Fest"
        className="absolute left-1/2 -translate-x-1/2 top-[4%] sm:top-[11%] h-[26vh] sm:h-[40vh] md:h-[44vh] max-h-[440px] min-h-[150px] w-auto object-contain z-25 drop-shadow-sm"
      />

      {/* 4. BLOQUE CENTRAL DE TEXTOS, FECHA Y BOTÓN:
          - En MÓVILES (< md): Ubicado a top-[29%] ajustado sin superponerse con el título ni tapar texto.
          - En PC/DESKTOP (>= md): En su posición original exacta top-[54%] max-w-[720px] */}
      <div className="absolute left-1/2 -translate-x-1/2 top-[29%] sm:top-[38%] md:top-[54%] w-[94%] md:w-[100%] max-w-[720px] text-center flex flex-col items-center gap-2 md:gap-4 z-30 pointer-events-auto px-2">
      ...
      {/* 5. Personaje My Melody Izquierda (mascot_personaje.png):
          - En MÓVILES (< md): Subida a bottom-[11%] para elevarse sobre la cenefa inferior de forma armoniosa.
          - En PC/DESKTOP (>= md): Versión original bottom-[8%] h-[58vh] max-h-[520px] */}
      <img
        src="/assets/mascot_personaje.png"
        alt="My Melody Mascot"
        className="absolute left-[0.5%] sm:left-[1%] bottom-[11%] md:bottom-[8%] h-[26vh] md:h-[58vh] max-h-[260px] md:max-h-[520px] min-h-[130px] md:min-h-[160px] w-auto object-contain drop-shadow-md z-25 opacity-90 md:opacity-100 pointer-events-none"
      />

      {/* 6. Ratita Flat con Globo (rata_mouse.png):
          - En MÓVILES (< md): Subida a bottom-[7.5%] para no quedar tapada por la cenefa inferior. */}
      <img
        src="/assets/rata_mouse.png"
        alt="Flat Mouse Balloon"
        className="absolute left-[2%] sm:left-[4%] bottom-[7.5%] md:bottom-[3%] h-[10vh] md:h-[19vh] max-h-[110px] md:max-h-[180px] min-h-[50px] md:min-h-[70px] w-auto object-contain drop-shadow-md z-30 pointer-events-none"
      />

      {/* 7. Elementos Derecha: Atril, Cesta Picnic, Árbol y Cojín Corazón (derecha_items.png):
          - En MÓVILES (< md): Subidos a bottom-[11%] para visibilidad impecable en móviles.
      ...
      <img
        ...
        className="absolute right-[0.5%] bottom-[11%] md:bottom-[7%] h-[27vh] md:h-[68vh] max-h-[270px] md:max-h-[600px] min-h-[130px] md:min-h-[180px] w-auto object-contain drop-shadow-md hover:scale-102 transition-transform z-25 opacity-90 md:opacity-100 pointer-events-none"
      />
